...
public class ScaleInXYApplier implements ImageApplier {
    ...
    public void apply(@NonNull final ImageDisplayer displayer, @NonNull final Image image) {
        ObjectAnimator animatorX = ObjectAnimator.ofFloat(displayer, "scaleX", 1f, 0f);
        ObjectAnimator animatorY = ObjectAnimator.ofFloat(displayer, "scaleY", 1f, 0f);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                ObjectAnimator animatorX = ObjectAnimator.ofFloat(displayer, "scaleX", 0f, 1f);
                ObjectAnimator animatorY = ObjectAnimator.ofFloat(displayer, "scaleY", 0f, 1f);
                AnimatorSet animator = new AnimatorSet();
                animator.playTogether(animatorX, animatorY);
                animator.start();
            }
