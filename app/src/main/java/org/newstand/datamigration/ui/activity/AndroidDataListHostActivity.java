...
import org.newstand.datamigration.ui.fragment.SystemAppListFragment;
...
public class AndroidDataListHostActivity extends DataListHostActivity {
    ...
    protected Fragment getFragmentByCategory(DataCategory category) {
        switch (category) {
            ...
            case App:
                return SettingsProvider.isInstallDataEnabled() ? new AppListFragment() : new AppOnlyApkListFragment();
            case SystemApp:
                return SettingsProvider.isInstallDataEnabled() ? new SystemAppListFragment() : new SystemAppOnlyApkListFragment();
            case Sms:
