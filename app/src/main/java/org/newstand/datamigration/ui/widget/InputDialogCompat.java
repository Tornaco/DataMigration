...
public class InputDialogCompat {

    private AlertDialog dialog;
    private EditText editText;

    private InputDialogCompat(AlertDialog dialog, EditText editText) {
        this.dialog = dialog;
    ...
    public static class Builder {
        ...
        private InputDialogCompat inputDialogCompat; // the proxy dialog
         ...
         * @param listener The {@link InputDialogCompat.ButtonActionListener} to use.
        ...
        public Builder setPositiveButton(final int textId, final ButtonActionListener listener) {
            ...
            builder.setPositiveButton(textId, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    boolean intercept = onInterceptButtonAction(which, inputDialogCompat.getInputText());
                    if (!intercept) {
                        if (positiveButtonActionListener != null) {
                            positiveButtonActionListener.onClick(inputDialogCompat.getInputText());
                        }
                    }
                }
            });
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!intercept) {
                        if (negativeButtonActionListener != null) {
                            negativeButtonActionListener.onClick(inputDialogCompat.getInputText());
                        }
                    }
                }
            });
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    if (!intercept) {
                        if (neutralButtonActionListener != null) {
                            neutralButtonActionListener.onClick(inputDialogCompat.getInputText());
                        }
                    }
                }
            });
         ...
         * {@link #setOnDismissListener(InputDialogCompat.OnDismissListener)
         * setOnDismissListener}.</p>
         *
         * @return This Builder object to allow for chaining of calls to set methods
         * @see #setCancelable(boolean)
         * @see #setOnDismissListener(InputDialogCompat.OnDismissListener)
         */
            ...
            builder.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface d) {
                    if (onCancelListener != null) {
                        onCancelListener.onCancel(inputDialogCompat.getInputText());
                    }
                }
            });
            return this;
            ...
            builder.setOnDismissListener(new DialogInterface.OnDismissListener() {
                ...
                public void onDismiss(DialogInterface d) {
                    ...
                    if (onDismissListener != null) {
                        onDismissListener.onDismiss(inputDialogCompat.getInputText());
                    }
                }
            });
            return this;
         ...
         *
         * @param intercepter The {@link InputDialogCompat.ButtonActionIntercepter} to use.
         * @return This Builder object to allow for chaining of calls to set methods
         */
        ...
        /**
         * Creates a {@link InputDialogCompat} with the arguments supplied to this builder and
         * {@link Dialog#show()}'s the dialog.
         */
        public InputDialogCompat show() {
            initLayout();
        ...
        /**
         * Creates a {@link InputDialogCompat} with the arguments supplied to this builder. It does not
         * {@link Dialog#show()} the dialog. This allows the user to do any extra processing
         * before displaying the dialog. Use {@link #show()} if you don't have any other processing
         * to do and want this to be created and displayed.
         */
        public InputDialogCompat create() {
            initLayout();
        ...
        private InputDialogCompat createInputDialog(AlertDialog dialog) {
            inputDialogCompat = new InputDialogCompat(dialog, obtainEditText(dialog));
            return inputDialogCompat;
        }
